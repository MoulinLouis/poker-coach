export const en = {
  ...
  setup: {
    ...
    ante: "Ante",
    tournamentSection: "Tournament settings",
    firstPayout: "1st payout",
    secondPayout: "2nd payout",
  ...
  routes: {
    ...
    history: {
      ...
      filterModel: "model",
      filterStatus: "status",
      filterPromptVersion: "prompt version",
      ...
      detailPrompt: "Prompt",
      detailStatus: "Status",
      detailTokens: "Tokens (in/out/reasoning)",
      detailCost: "Cost",
      detailLatency: "Latency",
      sectionAdvice: "Advice",
      sectionReasoning: "Reasoning stream",
      sectionPrompt: "Rendered prompt",
      sectionGameState: "Game state",
      sectionError: "Error",
      toPrefix: "to",
      bbUnit: "bb",
    },
